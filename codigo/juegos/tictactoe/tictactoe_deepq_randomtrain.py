...
def train_dqn_agent_random_opponent(episodes=10000):
    env = TicTacToe()
    agent = DQNAgent(alpha=0.001, gamma=0.9)
    win_percentages = []
    draw_percentages = []
    ...
    for episode in range(episodes):
        ...
        while not done:
            ...
            # Guardar la experiencia y actualizar la red
...
if __name__ == "__main__":
    ...
    plt.title(f"Tic Tac Toe Deep Q-Learning | Porcentaje de victorias y empates del agente vs elección aleatoria", fontsize=14, fontweight='bold')
