...
log_file_path = os.path.join(log_dir, f"log_zork_deepqnv2_{timestamp}_epochs_{NUM_EPOCHS}_groq.txt")
...
torch.save(policy_net.state_dict(), os.path.join(models_dir, f"model__zork_deepqnv2_{timestamp}_epochs_{NUM_EPOCHS}_groq.pth"))
...
plt.savefig(os.path.join(results_dir, f"viz_zork_avg_rewards_{timestamp}_epochs_{NUM_EPOCHS}_groq.png"))
